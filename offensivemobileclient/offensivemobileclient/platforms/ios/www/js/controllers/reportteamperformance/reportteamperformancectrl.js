angular.module('offensiveapp')
    .controller('reportteamperformancecontroller', ['$scope', '$http', '$state', '$ionicPopup', '$location', 'authenticationservice', 'applicationservice', 'marketingservice', 'teamsservice', 'businessobjectsservice',
            ...
            $(function () {
                ...
                applicationService.getLoggedInSecurityUserID(function (securityUserID) {
                    applicationService.getCurrentTeam(function (currentTeamID) {
                        ...
                        businessObjectsService.retrieveTotalAccountsCountForTeam(theCurrentTeam, function (data) {
                            $scope.totalaccounts = data.outData.totalaccounts;
                            $scope.$apply();
                        });

                        businessObjectsService.retrieveTotalAccountsByMonthForTeam(theCurrentTeam, function (data) {
                        ...
                        businessObjectsService.retrieveTotalNewSalesTargetsForMonthForTeam(theCurrentTeam, momenttoday.month() - 1, momenttoday.year(), function (data) {

                            $scope.totaltargetsinplay = data.outData.newsalestargetscount;

                            businessObjectsService.retrieveTotalSalesTargetsConvertedToAccountsForMonthForTeam(theCurrentTeam, momenttoday.month() - 1, momenttoday.year(), function (data) {
                        ...
                        businessObjectsService.retrieveTotalNewSalesTargetsForPreviousMonthsForTeam(theCurrentTeam, function (data) {

                            var newsalestargets = data;

                            businessObjectsService.retrieveTotalSalesTargetsConvertedToAccountsForPreviousMonthsForTeam(theCurrentTeam, function (data) {
                        ...
                        businessObjectsService.retrieveDealEstimateCountForPreviousMonthsForTeam(theCurrentTeam, function (data) {
                        ...
                        businessObjectsService.retrieveDealCountForPreviousMonthsForTeam(theCurrentTeam, function (data) {
                        ...
                        businessObjectsService.retrieveDealValueForPreviousMonthsForTeam(theCurrentTeam, function (data) {
                        ...
                        businessObjectsService.retrieveRevenueForPreviousMonthsForTeam(theCurrentTeam, function (data) {
