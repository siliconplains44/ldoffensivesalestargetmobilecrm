angular.module('offensiveapp')
    .controller('reportmypipelinecontroller', ['$scope', '$http', '$state', '$ionicPopup', '$location', 'authenticationservice', 'applicationservice', 'marketingservice', 'teamsservice', 'businessobjectsservice',
            ...
            $(function () {
                ...
                applicationService.getLoggedInSecurityUserID(function (securityUserID) {
                    applicationService.getCurrentTeam(function (currentTeamID) {
                        ...
                        businessObjectsService.retrievePipelineTotalsForMonthForUser(securityUserID, theCurrentTeam, function (data) {
                        ...
                        businessObjectsService.retrieveSalesTargetsAllocatedAcrossPipeline(securityUserID, theCurrentTeam, function (data) {
