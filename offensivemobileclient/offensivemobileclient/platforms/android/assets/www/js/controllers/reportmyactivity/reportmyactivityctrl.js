angular.module('offensiveapp')
    .controller('reportmyactivitycontroller', ['$scope', '$http', '$state', '$ionicPopup', '$location', 'authenticationservice', 'applicationservice', 'marketingservice', 'teamsservice', 'businessobjectsservice',
            ...
            $(function () {
                ...
                applicationService.getLoggedInSecurityUserID(function (securityUserID) {
                    applicationService.getCurrentTeam(function (currentTeamID) {
                        ...
                        businessObjectsService.retrieveActivityDataForUser(securityUserID, function (data) {
